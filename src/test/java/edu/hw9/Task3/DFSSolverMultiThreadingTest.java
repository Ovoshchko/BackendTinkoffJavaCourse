...
class DFSSolverMultiThreadingTest {

    private DFSSolverMultiThreading solver;

    @BeforeEach
    void create() {
        solver = new DFSSolverMultiThreading();
    }

    @ParameterizedTest
    @DisplayName("--Defined paths Test")
    @MethodSource("onlyOnePathMaze")
    void solve(Cell[][] cells, List<Coordinate> coordinates, Coordinate start, Coordinate finish) {
