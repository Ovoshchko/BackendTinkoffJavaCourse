...
public class BenchmarkPerformanceTest {
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
            .include(BenchmarkPerformanceTest.class.getSimpleName())
    ...
    public void setup() {
        ...
        methodHandler = MethodHandles.lookup().findVirtual(Student.class, "name", MethodType.methodType(String.class));
        CallSite lambdaMetafactory = LambdaMetafactory.metafactory(
        ...
        lambda = (Function<Student, String>) lambdaMetafactory.getTarget().invokeExact();
    }
    ...
    public void handler(Blackhole bh) throws Throwable {
        String name = (String) methodHandler.invoke(student);
        bh.consume(name);
    }
